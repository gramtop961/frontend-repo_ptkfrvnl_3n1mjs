    ...
    <section className="relative h-[64vh] min-h-[420px] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 h-full flex items-center">
        <div className="max-w-2xl">
          <h1 className="text-4xl md:text-5xl font-semibold text-white drop-shadow-md">A Home with Heart</h1>
          <p className="mt-4 text-white/80 text-lg">St George’s House • Residential Care Home</p>
